...
@section('content')
    ...
    <form id="kriteria1" method="POST" action="{{ route('kriteria1.submit') }}" enctype="multipart/form-data">
        @csrf
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            const form = document.querySelector('#kriteria1');
            const submitUrl = '{{ route('kriteria1.submit') }}';
