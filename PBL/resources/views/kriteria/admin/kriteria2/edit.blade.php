...
@section('content')
    ...
    <form id="kriteria2-edit" method="POST" action="{{ route('kriteria2.update', $kriteria->id_detail_kriteria) }}" enctype="multipart/form-data" {{ $disabled }}>
        @csrf
        @method('PUT')
