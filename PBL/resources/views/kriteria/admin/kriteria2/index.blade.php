                                ...
                                <tr>
                                    ...
                                    <td class="action-icons">
                                        ...
                                        @if (($status === 'progress' || $status === 'rev' || $status === 'draft') && $item->status_selesai !== 'submit')
                                            <a
                                                href="{{ url('/kriteria/admin/kriteria2/edit/' . $item->id_detail_kriteria) }}">
                                        ...
                                        @if ($status === 'acc')
                                            <a
                                                href="{{ url('/kriteria/admin/kriteria2/print/' . $item->id_detail_kriteria) }}">
        ...
        function showDeleteAlert(id) {
            ...
            if (alert) {
                ...
                currentDeleteForm = document.querySelector(
                    `form[action="${window.location.origin}/kriteria/admin/kriteria2 /delete/${id}"]`);
            } else {
