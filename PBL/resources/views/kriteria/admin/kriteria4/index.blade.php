...
@section('content')
    ...
    <div class="card">
        <div class="card-title">
            ...
            <button class="add-button"><a href="/kriteria/admin/kriteria4/create">Tambah Data</a></button>
        </div>
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="action-icons">
                                        <a href="{{ url('/kriteria/admin/kriteria4/view/' . $item->id_detail_kriteria) }}">
                                        ...
                                        @if (($status === 'progress' || $status === 'rev' || $status === 'draft') && $item->status_selesai !== 'submit')
                                            <a
                                                href="{{ url('/kriteria/admin/kriteria4/edit/' . $item->id_detail_kriteria) }}">
                                                <button class="action-button"><img src="{{ asset('assets/icon/edit.png') }}"
                                                        alt="Edit Icon"></button>
                                            </a>
                                            <form
                                                action="{{ url('/kriteria/admin/kriteria4/delete/' . $item->id_detail_kriteria) }}"
                                        ...
                                        @if ($status === 'acc')
                                            <a
                                                href="{{ url('/kriteria/admin/kriteria4/print/' . $item->id_detail_kriteria) }}">
        ...
        function showDeleteAlert(id) {
            ...
            if (alert) {
                ...
                currentDeleteForm = document.querySelector(
                    `form[action="${window.location.origin}/kriteria/admin/kriteria4/delete/${id}"]`);
            } else {
