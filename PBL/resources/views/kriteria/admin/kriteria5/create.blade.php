...
@section('content')
    ...
    <form id="kriteria5" method="POST" action="{{ route('kriteria5.submit') }}" enctype="multipart/form-data">
        @csrf
        ...
        <!-- Bagian 1: Penetapan -->
        <div class="card" id="pnetapan-section">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            const form = document.querySelector('#kriteria5');
            const submitUrl = '{{ route('kriteria5.submit') }}';
                            ...
                            fetch(window.location.href, { method: 'GET' })
                                ...
                                .then(html => {
                                    if (html.includes('Data berhasil disimpan')) {
                                        ...
                                        setTimeout(() => {
                                            window.location.href = '{{ route('index.admin.kriteria5') }}';
                                        }, 2000);
                                    } else {
