...
@section('content')
    <!-- Header -->
    <div class="header">
        <h3>Beranda / Kriteria 5 / Edit</h3>
        <h2>Edit Kriteria 5</h2>
    </div>
    ...
    <form id="kriteria5-edit" method="POST" action="{{ route('kriteria5.update', $kriteria->id_detail_kriteria) }}" enctype="multipart/form-data" {{ $disabled }}>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                const form = document.querySelector('#kriteria5-edit');
                const submitUrl = '{{ route('kriteria5.update', $kriteria->id_detail_kriteria) }}';
