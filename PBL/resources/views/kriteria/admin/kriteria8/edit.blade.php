...
@section('content')
    <!-- Header -->
    <div class="header">
        <h3>Beranda / Kriteria 8 / Edit</h3>
        <h2>Edit Kriteria 8</h2>
    </div>
    ...
    <form id="kriteria8-edit" method="POST" action="{{ route('kriteria8.update', $kriteria->id_detail_kriteria) }}" enctype="multipart/form-data" {{ $disabled }}>
        @csrf
        @method('PUT')
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                const form = document.querySelector('#kriteria8-edit');
                const submitUrl = '{{ route('kriteria8.update', $kriteria->id_detail_kriteria) }}';
