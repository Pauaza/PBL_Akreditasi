...
Route::middleware(['auth'])->group(function () {
    // Logout (dapat diakses oleh semua peran yang sudah login)
    ...
    Route::middleware(['authorize:ADM'])->group(function () {
        ...
        Route::delete('/kriteria/admin/kriteria6/delete/{id}', [Kriteria6AdminController::class, 'destroy'])->name('kriteria6.delete');
        ...
        Route::delete('/kriteria/admin/kriteria8/delete/{id}', [Kriteria8AdminController::class, 'destroy'])->name('kriteria8.delete');
